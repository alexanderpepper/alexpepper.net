<template lang="pug">
  v-container.app(fluid)
    v-slide-y-transition(mode='out-in')
      h1 Privacy Policy
      p This privacy notice discloses the privacy practices for app developee by Alex Pepper. This privacy notice applies solely to information my iOS and Android apps. 
      p
      ...
      p If you contact me for support, I will use your email address to respond to you, regarding the reason you contacted us. I will not share your information with any third party outside of our organization.
      p
        strong Security 
      ...
      p Wherever the apps collect sensitive information, that information is encrypted and stored in a secure way.
